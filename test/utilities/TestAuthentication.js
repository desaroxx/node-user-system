...
var Authentication = require('app/utilities/Authentication');
...
describe('TestAuthentication', function() {
	...
	describe('getUser()', function() {
		...
		it('should return a user', function() {
			...
			var user = Authentication.getUser(token, secret.key);
		...
		it('should throw exception for invalid token', function() {
			...
			var user = Authentication.getUser(invalidToken, secret.key);
			expect(user).to.be.null;
		});

		it('should throw expection for undefined input', function() {
			var object = {};
			var user = Authentication.getUser(object.inexistantToken, secret.key);
			expect(user).to.be.null;
		});
	});
});